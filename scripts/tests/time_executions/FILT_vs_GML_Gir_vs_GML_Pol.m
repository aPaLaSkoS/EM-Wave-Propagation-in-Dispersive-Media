%% Compare Time Execution of: FILT , GML-Podlubny , GML-Garrappa
clear; clc; 
close all;
...
TE_gml_pod = zeros(1,length(Num_of_ts));
TE_gml_gar = zeros(1,length(Num_of_ts));
...
% fitobject_TE_gml = fit(Num_of_ts',TE_gml_pod','poly1');
...
% plot(Num_of_ts,TE_gml_pod,':g','LineWidth',1.5); hold off;
% 
...
% TEtot = sum(TE_filt+TE_gml_pod)/60
